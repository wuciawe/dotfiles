...
for s = 1, screen.count() do
    ...
    bottom_right_layout:add(batpct)
    bottom_right_layout:add(spacer)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume", function () awful.util.spawn_with_shell("amixer -q sset Master 5%+ unmute") end),
    awful.key({}, "XF86AudioLowerVolume", function () awful.util.spawn_with_shell("amixer -q sset Master 5%- unmute") end),
    ...
    -- awful.key({ modkey, "Shift" }, "h", function() awful.client.incwfact(1) end),
    -- awful.key({ modkey, "Shift" }, "l", function() awful.client.incwfact(-1) end),
